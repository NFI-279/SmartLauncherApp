    ...
    public class SkeetComboBox : ComboBox
    {
        ...
        public void DrawItem_(System.Object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            ...
            if ((e.State & DrawItemState.Selected) == DrawItemState.Selected)
            {
                ...
                e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(206, 59, 120)), e.Bounds);
            }
            else
            {
                //-- Not Selected
            ...
            //-- Text
            e.Graphics.DrawString(base.GetItemText(base.Items[e.Index]), new Font("Josefin Sans", 8), Brushes.White, new Rectangle(e.Bounds.X + 2, e.Bounds.Y + 2, e.Bounds.Width, e.Bounds.Height));
        ...
        private Color _BaseColor = Color.FromArgb(79, 28, 78);
        private Color _BGColor = Color.FromArgb(27, 19, 53);
        ...
        public SkeetComboBox()
        {
            ...
            StartIndex = 0;
            ItemHeight = 18;
            Font = new Font("Josefin Sans", 8, FontStyle.Regular);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("v", new Font("Josefin Sans", 7), Brushes.White, new Point(Width - 15 , 6));
